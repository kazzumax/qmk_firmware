...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_ADJUST] =  LAYOUT(
      ...
      _______, _______,   KC_LGUI, KC__VOLDOWN, KC__VOLUP, KC__MUTE, _______, _______,    _______, _______, _______, _______, KC_LEFT, KC_RGHT, _______, _______,
      _______, _______,   KC_LSFT, _______,     _______,   _______,  _______, _______,    _______, _______, _______, _______, KC_DOWN, KC_DOWN, _______, _______,
